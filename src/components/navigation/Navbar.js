...
function Navbar({loggedIn, user, setLoggedIn}) {
    console.log(user)
    ...
    return (
        ...
        <AppBar position="static" style={{backgroundColor:'#1F4A9F',boxShadow:'0 0px 10px 5px rgb(0 0 0 / 20%)'}}>
            ...
            >
                <Link to='/departments' style={{color:'white', textDecoration:'none', marginTop:'5px' }}>
                    <Typography ><CorporateFareOutlinedIcon/>Departments</Typography>
                </Link>
                ...
                <Link to='/tasks' style={{color:'white', textDecoration:'none', marginTop:'5px' }}>
                    <Typography ><TaskAltOutlinedIcon/>Tasks</Typography>
                </Link>

                <Link to='/items' style={{color:'white', textDecoration:'none', marginTop:'5px' }}>
                    <Typography ><PlaylistAddCheckOutlinedIcon/>Items</Typography>
                </Link>
